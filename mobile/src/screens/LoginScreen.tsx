  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0A0A0A] text-white font-sans relative overflow-hidden">
      ...
      <motion.div
        ...
        className="mx-6 bg-[#252525] rounded-[1.5rem] p-6 shadow-xl flex-1 max-h-[500px] mb-auto border border-white/5"
      >
        ...
        <div className="mt-8 flex flex-col items-center">
          ...
          <span className="text-[#888888] text-[13px]">
            Ainda não tem conta?{' '}
            <Link to="/register" className="text-[#F59E0B] hover:text-[#D97706] font-semibold transition-colors cursor-pointer">
              Cadastre aqui
            </Link>
          </span>
        </div>
      ...
      {/* Footer */}
      <div className="text-center w-full pb-6 pt-4">
