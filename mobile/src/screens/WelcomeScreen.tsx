...
export const WelcomeScreen: React.FC = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-between min-h-screen bg-[#0A0A0A] overflow-hidden font-sans">
      ...
      >
        ...
        >
          <div className="p-4 bg-[#F59E0B] shadow-2xl mb-4 relative group cursor-pointer rounded-sm">
            <Scissors className="w-16 h-16 text-black relative z-10" strokeWidth={2} />
          </div>
          <h1 className="text-4xl font-extrabold tracking-widest text-white mt-1 drop-shadow-lg">
            AGENDEI
          </h1>
        </motion.div>
        ...
        <div className="text-left space-y-3 w-full self-start max-w-sm ml-2">
          ...
          >
            Agende agora<br/>mesmo o seu corte
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6, delay: 0.7 }}
            className="text-gray-200 text-lg pr-4"
          >
            Faça um de nossos serviços com os melhores profissionais
          </motion.p>
        </div>
      </motion.div>
