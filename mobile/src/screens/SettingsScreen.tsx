...
import { Scissors, Home, Settings as SettingsIcon, EyeOff, Eye } from 'lucide-react';
...
export const SettingsScreen: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#111111] text-white font-sans relative overflow-x-hidden pb-24">
      ...
      >
        <div className="p-2 bg-[#F59E0B] rounded-sm flex items-center justify-center">
          <Scissors className="w-6 h-6 text-black" strokeWidth={2.5} />
        </div>
        <h1 className="text-2xl font-extrabold tracking-widest text-white flex items-center">
          AGENDEI
        </h1>
      </motion.div>
      ...
      <motion.div
        ...
        className="px-6"
      >
        <h2 className="text-[28px] font-extrabold text-white tracking-wide mb-1">
          Configurações
        </h2>
        <p className="text-[#AAAAAA] text-[15px] font-medium mb-3">
          Detalhes pessoais
        </p>
